...
Pour enlever un item, il suffit de le _filtrer_. le but est de produire un nouveau tableau qui ne contiendra pas cet item. On utilise `filter` pour cela.
